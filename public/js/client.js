...
var getBadges = function(t){
  ...
  .then(function(cardName){
    ...
    return [badgeDynamique, badgeStatique, badgePopup, badgeURL];
  });
};

var boardButtonPopup = {
...
var boardButtonCallback = function(t){
  return t.popup({
    ...
    items: [boardPopup,boardLink]
  });
};


var optionsCardButtons = [{
      // usually you will provide a callback function to be run on button click
      // we recommend that you use a popup on click generally
      icon: GRAY_ICON, // don't use a colored icon here
      text: 'Ouvrir un popup',
...
TrelloPowerUp.initialize({
  ...
  'board-buttons': function(t, options){
    return [boardButtonPopup,boardButtonLink];
  },
  'card-badges': function(t, options){
    return getBadges(t);
  },
  'card-buttons': function(t, options) { return optionsCardButtons; },
